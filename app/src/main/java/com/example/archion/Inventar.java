...
public class Inventar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton batoh_tlacitko_otevr = findViewById(R.id.batoh_tlacitko_otevr);

        batoh_tlacitko_otevr.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                startActivity(intent);
                Intent intent = new Intent(Inventar.this, Louka_lokace.class);
                startActivity(intent);
            }
        });
